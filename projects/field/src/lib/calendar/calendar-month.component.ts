...
import { DATE_RANGE_SELECTION_STRATEGY, DateRangeSelectionStrategy } from '../datepicker/date-range-selection-strategy';
...
@Component({
  ...
  exportAs: 'CalendarMonth',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CalendarMonthComponent<D> implements AfterContentInit, OnChanges, OnDestroy {
  ...
  constructor(readonly _changeDetectorRef: ChangeDetectorRef,
              ...
              @Inject(DATE_RANGE_SELECTION_STRATEGY) @Optional()
                  private _rangeStrategy?: DateRangeSelectionStrategy<D>) {
  ...
  private _createWeekCells() {
    ...
    for (let i = 0, cell = this._firstWeekOffset; i < daysInMonth; i++, cell++) {
      ...
      this._weeks[this._weeks.length - 1].push(new CalendarCell<D>(
        i + 1, dateNames[i],
        ariaLabel,
        enabled,
        cellClasses,
