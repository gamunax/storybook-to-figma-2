...
import { FieldModule, FieldSize, FieldVariants, AtlasInput, HaloSelectChange, HaloSelectTypeaheadChange, OptionComponent } from 'atlas-field';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { ButtonModule } from 'atlas-button';
import { coerceBooleanProperty, coerceNumberProperty } from '@angular/cdk/coercion';
import { CdkConnectedOverlay } from '@angular/cdk/overlay';
import { startWith, switchMap, take, filter, map } from 'rxjs/operators';
...
const TYPEAHEAD_TEMPLATE: Story<TypeaheadComponent> = (args: TypeaheadComponent) => ({
  props: { ...args }, 
});

export const Typeahead = TYPEAHEAD_TEMPLATE.bind({});
Typeahead.args = {
  typeahead: true,
};
