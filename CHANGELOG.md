## [9.0.6](https://github.com/mmctech/proxima-atlas/compare/v9.0.6..v9.0.5) (2025-07-06)
...
* **select:**  select on click show list and enable typeahead ([#519](https://github.com/mmctech/proxima-atlas/issues/519)) ([bc73f47](https://github.com/mmctech/proxima-atlas/commit/bc73f4738331ddd62c65c9afb0f4cc2ca8d5726c))
...
# [9.0.0](https://github.com/mmctech/proxima-atlas/compare/v9.0.0..v8.0.2) (2025-02-17)
...
* **modal:** hide & close and dynamic functionality from modal ([#259](https://github.com/mmctech/proxima-atlas/pull/259)) ([5dfe98d](https://github.com/mmctech/proxima-atlas/commit/7ecd82f9922622a36a342a6659439a1173135262))
...
* **theming:** :boom: Atlas v2 new theming ([a62deae](https://github.com/mmctech/proxima-atlas/commit/a62deae49f3ade474026d1965516a9ee47c67e2e))
...
* **core: cdk, field, modal, radio, slider, tabs:** 🐛 [A2-125](https://halo-react-team.atlassian.net/browse/A2-125) out of memory - 
...
* **build:** This update removes the @mmctech namespace from the library as required by the registry. 
...
* **ng-packagr:** fix angular build issues [[#48](https://github.com/mmctech/proxima-atlas/issues/48)] ([a437423](https://github.com/mmctech/proxima-atlas/commit/a43742395000da0ef6f186ed96be2433080aa07f))
...
* **switch:** [HDF-111](https://halo-react-team.atlassian.net/browse/HDF-111) create inputs for aria controls ([8fc2407](https://bitbucket.org/halopowered/ui-components/commits/8fc240708a6a1c4536a463e176e50ebf9a7e5b96)), closes [#263](https://bitbucket.org/halopowered/ui-components/pull-requests/263)
...
* **filedrop:** [HDF-70](https://halo-react-team.atlassian.net/browse/HDF-70) reset min-width style when fullWidth prop is true ([f301bd2](https://bitbucket.org/halopowered/ui-components/commits/f301bd22f114e7e56e369781c713e7892bc89e50))
...
* **button:** [PRXMCL-287](https://halo-react-team.atlassian.net/browse/PRXMCL-287) icon-button subcomponent ([96454a8](https://bitbucket.org/halopowered/ui-components/commits/96454a866431fa460fa778c47c28239526a2f657)), closes [#87](https://bitbucket.org/halopowered/ui-components/pull-requests/87)
...
* **icons:** [PRXMCL-259](https://halo-react-team.atlassian.net/browse/PRXMCL-259) update icon sizings to match design ([8e47ee4](https://bitbucket.org/halopowered/ui-components/commits/8e47ee4e2d3bbe6f07ac46d2eed842c3f8e6d185)), closes [#63](https://bitbucket.org/halopowered/ui-components/pull-requests/63)
...
* **theming-service, app-module, appbar-stories:** [PRXMCL-256](https://halo-react-team.atlassian.net/browse/PRXMCL-256) Theming service instantiated many times ([3342ce9](https://bitbucket.org/halopowered/ui-components/commits/3342ce91adea8179cda9f90a67328d5f9ed0f558)), closes [#76](https://bitbucket.org/halopowered/ui-components/pull-requests/76)


### Features

* **avatar:** [PRXMCL-173](https://halo-react-team.atlassian.net/browse/PRXMCL-173) Avatar component variants, config and story ([9e58739](https://bitbucket.org/halopowered/ui-components/commits/9e587397551be0771fd546963058d43a9c64cc01)), closes [#27](https://bitbucket.org/halopowered/ui-components/pull-requests/27)
* **badge:** [PRXMCL-180](https://halo-react-team.atlassian.net/browse/PRXMCL-180) add new badge directive ([6da30ac](https://bitbucket.org/halopowered/ui-components/commits/6da30ac53b5b41875a4d7f740edf7b2957fa328c)), closes [#51](https://bitbucket.org/halopowered/ui-components/pull-requests/51)
* **breadcrumb:** [PRXMCL-175](https://halo-react-team.atlassian.net/browse/PRXMCL-175) add breadcrumb component ([ea681d0](https://bitbucket.org/halopowered/ui-components/commits/ea681d066b57828cd617993eab99053d411671b4)), closes [#42](https://bitbucket.org/halopowered/ui-components/pull-requests/42)
* **chips:** [PRXMCL-177](https://halo-react-team.atlassian.net/browse/PRXMCL-177) basic-chips-component ([57b78ac](https://bitbucket.org/halopowered/ui-components/commits/57b78ac7c9edbc2150725ab59bc2cd503f97cf36)), closes [#70](https://bitbucket.org/halopowered/ui-components/pull-requests/70)
* **button:** style configuation for button, icon added to default config, class updates in button and icon packages ([126ec26](https://bitbucket.org/halopowered/ui-components/commits/126ec263adf4fea2e6ffa4821fe5e327fd3f2dde)), closes [#24](https://bitbucket.org/halopowered/ui-components/pull-requests/24)
* **docs:** [PRXMCL-38](https://halo-react-team.atlassian.net/browse/PRXMCL-38) provide decision path for directives vs services and components ([6680ea3](https://bitbucket.org/halopowered/ui-components/commits/6680ea3a7a4a0e0cec2cad81f3fcba1932ccc813)), closes [#21](https://bitbucket.org/halopowered/ui-components/pull-requests/21)
* **dashboard:** [PRXMCL-195](https://halo-react-team.atlassian.net/browse/PRXMCL-195) login and data display sample routes ([92ac8d6](https://bitbucket.org/halopowered/ui-components/commits/92ac8d69d6e2521b6bccc2e091756f8335d7bef7)), closes [#48](https://bitbucket.org/halopowered/ui-components/pull-requests/48)
* **data-display:** [PRXMCL-210](https://halo-react-team.atlassian.net/browse/PRXMCL-210) add initial template story for data display sample layout ([e36e015](https://bitbucket.org/halopowered/ui-components/commits/e36e0158ba15857734af45baa1732fea8caf1c78)), closes [#47](https://bitbucket.org/halopowered/ui-components/pull-requests/47)
* **data-upload:** [PRXMCL-237](https://halo-react-team.atlassian.net/browse/PRXMCL-237) update template with latest select component, update dashboard template ([e2c5cd2](https://bitbucket.org/halopowered/ui-components/commits/e2c5cd21ab10e8718c58a8cc7d4e3cdd562ecdad)), closes [#57](https://bitbucket.org/halopowered/ui-components/pull-requests/57)
* **rado, checkbox:** [PRXMCL-106](https://halo-react-team.atlassian.net/browse/PRXMCL-106) [PRXMCL-114](https://halo-react-team.atlassian.net/browse/PRXMCL-114) [PRXMCL-172](https://halo-react-team.atlassian.net/browse/PRXMCL-172) [PRXMCL-170 ] [PRXMCL-115](https://halo-react-team.atlassian.net/browse/PRXMCL-115) [PRXMCL-105 ] radio, checkbox, label, input packages init, styles, sample template ([2443e95](https://bitbucket.org/halopowered/ui-components/commits/2443e9563f018be45e4b6b57a695ade9b5597a5f)), closes [#26](https://bitbucket.org/halopowered/ui-components/pull-requests/26)
* **cdk:**  [PRXMCL-107](https://halo-react-team.atlassian.net/browse/PRXMCL-107) spacer-class-implementation ([1980b5a](https://bitbucket.org/halopowered/ui-components/commits/1980b5acab3f6ecb2795a0fcbe36084410abe385)), closes [#53](https://bitbucket.org/halopowered/ui-components/pull-requests/53)
* **card:**  [PRXMCL-116](https://halo-react-team.atlassian.net/browse/PRXMCL-116) card pattern ([084a476](https://bitbucket.org/halopowered/ui-components/commits/084a476bf2d982f4548d73bea4797225976f5e44)), closes [#72](https://bitbucket.org/halopowered/ui-components/pull-requests/72)
* **progress-bar:**  [PRXMCL-233](https://halo-react-team.atlassian.net/browse/PRXMCL-233) progress-bar-component ([d8424db](https://bitbucket.org/halopowered/ui-components/commits/d8424db08c00cdc871b0d59c6493ad3cd0c2a3c5)), closes [#58](https://bitbucket.org/halopowered/ui-components/pull-requests/58)
* **list:** [PRXMCL-218](https://halo-react-team.atlassian.net/browse/PRXMCL-218) add support for reverse colors, add list build script and target ([eb6c8d7](https://bitbucket.org/halopowered/ui-components/commits/eb6c8d70a4092d890720c75f23b664f820c5a1b5)), closes [#46](https://bitbucket.org/halopowered/ui-components/pull-requests/46)
* **list:** component setup, style config PRXMCL-186 ([b9578df](https://bitbucket.org/halopowered/ui-components/commits/b9578dfba254e0847acd454741fddaa636042b8e)), closes [#33](https://bitbucket.org/halopowered/ui-components/pull-requests/33)
* **menu:** [PRXMCL-185](https://halo-react-team.atlassian.net/browse/PRXMCL-185) component initial build ([1635120](https://bitbucket.org/halopowered/ui-components/commits/1635120c55649c9095f30f8583789ba4e8874eb9)), closes [#32](https://bitbucket.org/halopowered/ui-components/pull-requests/32)
* **option:** [PRXMCL-184](https://halo-react-team.atlassian.net/browse/PRXMCL-184) component init, style config, stories ([70810aa](https://bitbucket.org/halopowered/ui-components/commits/70810aae80d60277249ba7c259a1bf552669c3ae)), closes [#30](https://bitbucket.org/halopowered/ui-components/pull-requests/30)
* **select:** [PRXMCL-178](https://halo-react-team.atlassian.net/browse/PRXMCL-178) Select Component ([a16a95a](https://bitbucket.org/halopowered/ui-components/commits/a16a95a9c0aa3c7f68fe654d2be77748a5983dbb)), closes [#49](https://bitbucket.org/halopowered/ui-components/pull-requests/49)
* **switch:** [PRXMCL-232](https://halo-react-team.atlassian.net/browse/PRXMCL-232) switch-component ([55dd9ef](https://bitbucket.org/halopowered/ui-components/commits/55dd9efbdac0417a68e025ef5a2975ac6378c5d3)), closes [#73](https://bitbucket.org/halopowered/ui-components/pull-requests/73)
* **table:** [PRXMCL-176](https://halo-react-team.atlassian.net/browse/PRXMCL-176) init table component, subcomponents and stories ([40c4539](https://bitbucket.org/halopowered/ui-components/commits/40c45393fcd2d0b66da39bacb566e1b5f8a6c0ef)), closes [#43](https://bitbucket.org/halopowered/ui-components/pull-requests/43)
* **cdk:** [PRXMCL-189](https://halo-react-team.atlassian.net/browse/PRXMCL-189) [PRXMCL-200](https://halo-react-team.atlassian.net/browse/PRXMCL-200) [PRXMCL-193](https://halo-react-team.atlassian.net/browse/PRXMCL-193) tokens, packages upgraded to v0.0.2 ([84edb6e](https://bitbucket.org/halopowered/ui-components/commits/84edb6efcf2d5b3c71854101e8c866c79945fd1f)), closes [#35](https://bitbucket.org/halopowered/ui-components/pull-requests/35)
