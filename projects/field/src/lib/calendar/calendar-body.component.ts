...
import { config } from './calendar-body.theming';
...
export type CalendarCellClassFunction<D> =
    (date: D, view: 'month' | 'year' | 'multi-year') => CalendarCellCssClasses;
...
export class CalendarBodyComponent implements OnChanges, OnDestroy {
  /**
  ...
  /** Subject to trigger unsubscription from all observables. */
  ...
  @Output() readonly selectedValueChange: EventEmitter<CalendarUserEvent<number>> =
      new EventEmitter<CalendarUserEvent<number>>();

  /** Emits when the preview has changed as a result of a user action. */
  @Output() previewChange = new EventEmitter<CalendarUserEvent<CalendarCell | null>>();
