...
import { Actions, ButtonSizings, ButtonVariants, Density, IconSizes, Radii } from 'atlas-cdk';

@Component({
  selector: 'drawer-playground',
  templateUrl: './drawer-playground.component.html',
  styleUrls: ['./drawer-playground.component.scss'],
})
export class DrawerPlayground {
  ...
  isSideNavOpen = false;
  densityExpanded = Density.expanded;
