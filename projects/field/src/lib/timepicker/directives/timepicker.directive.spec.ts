...
xdescribe("TimepickerDirective", () => {
    ...
    beforeEach(() => {
        ...
        timepickerComponent = TestBed.createComponent(TimepickerComponent).componentInstance;
    });

    it("should register TimepickerComponent", () => {
    ...
    it("should throw Error if TimepickerComponent is not defined", () => {
        spyOnProperty(directive, "timepicker", "set").and.callThrough();
        expect(() => directive.timepicker = null).toThrowError("TimepickerComponent is not defined." +
